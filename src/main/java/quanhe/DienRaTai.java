...
public class DienRaTai extends QuanHe{
	...
	public void setThucThe1(ThucThe thucThe1) throws TypeException {
		...
		if(thucThe1 instanceof Event) {
			...
			throw new TypeException("Sai kieu kieu phai la Event");
		}
	...
	public void setThucThe2(ThucThe thucThe2) throws TypeException {
		// TODO Auto-generated method stub
				if(thucThe2 instanceof Location) {
					this.thucThe2=thucThe2;
				}else if(thucThe2 instanceof Country) {
					this.thucThe2=thucThe2;
				}
				else{
					throw new TypeException("Sai kieu kieu phai la Location or COuntry");
				}
